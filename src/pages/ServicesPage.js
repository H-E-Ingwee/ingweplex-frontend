...
function ServicesPage() {
  return (
    <div className="page-content">
      ...
      <img src="https://placehold.co/800x400/D9910B/FFFFFF?text=Transformative+Solutions" alt="Transformative Solutions" className="page-image" />

      <div className="service-list">
        <div className="service-item">
          <h3>1. Digital Transformation Expertise</h3>
        ...
        <div className="service-item">
          <h3>2. Personalized and Data-Driven Strategies</h3>
        ...
        <div className="service-item">
          <h3>3. Sustainability and Ethical Branding</h3>
        ...
        <div className="service-item">
          <h3>4. Customer Experience (CX) Optimization</h3>
        ...
        <div className="service-item">
          <h3>5. Agile and Flexible Solutions</h3>
        ...
        <div className="service-item">
          <h3>6. Measurable Return on Investment (ROI)</h3>
        ...
        <div className="service-item">
          <h3>7. Niche Specialization and Trusted Partnerships</h3>
